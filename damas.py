...
def quem_comeca():
    while True:
        ...
        if jogador=="C":
            ...
            return "C" #ISSO INDICA QUE O JOGADOR DE CIMA COMEÇA
        elif jogador=="B":
            print("Ok, jogador de baixo começa!")
            return "B" #ISSO INDICA QUE O JOGADOR DE BAIXO COMEÇA
        else:
            print("Entrada inválida!")
turno = 0
print_tabuleiro(tabuleiro_inicio())
matriz=(tabuleiro_inicio())
if quem_comeca()=="C": #AQUI, CONSIDERO A SITUAÇÃO DE JOGO EM QUE O JOGADOR DE CIMA COMEÇA
    while True:
        ...
        if turno%2==1: #E AS JOGADAS ÍMPARES SERÃO DO JOGADOR DE BAIXO, O JOGADOR 2
            ...
            print_tabuleiro(matriz)
        turno+=1
if quem_comeca()=="B": #AQUI, CONSIDERO A SITUAÇÃO DE JOGO EM QUE O JOGADOR DE BAIXO COMEÇA
    while True:
